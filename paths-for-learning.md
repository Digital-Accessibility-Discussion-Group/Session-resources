...
Short URL for this page: https://bit.ly/dadglearning.

<img width="200" height="200" alt="" src="https://raw.githubusercontent.com/Digital-Accessibility-Discussion-Group/Session-resources/2acf368c7fd1158159fc87e5dc6036e21c8e3204/bitly-dadglearning.png" />

## Courses

- Beginner/General/all roles
- Development
- Content design
- UI/visual design
- Testing
...
- All roles
  - [Introduction to Web Accessibility on edX by W3C](https://www.edx.org/course/web-accessibility-introduction) (Cost for certificate)
...
- UI/visual design
- Testing
  - [Introduction To Accessibility Testing on Ministry of Testing](https://www.ministryoftesting.com/courses/introduction-to-accessibility-testing)

### Paid

- All roles
  - [Accessibility and Inclusive Design Training by AbilityNet](https://abilitynet.org.uk/training)
  - [Accessibility training by Intopia](https://learn.intopia.digital/collections)
  - [Accessibility training by WebAIM](https://webaim.org/training/strategica11y/)
  - [A whole bunch of courses on A11y Collective](https://www.a11y-collective.com/courses-overview/)
  - [Digital Accessibility: Delivering inclusive digital content at Wellington Uni Professtional](https://wellingtonuni-professional.nz/course/digital-accessibility-delivering-inclusive-digital-content/)
  - Deque University Web Accessibility Curriculum Package to sit IAAP exams
    - [Certified Professional in Accessibility Core Competencies (CPACC) exam](https://dequeuniversity.com/online-courses/iaap-cpacc)
    - [Web Accessibility Specialist (WAS) exam](https://dequeuniversity.com/online-courses/iaap-cpacc)
...
- All roles
  ...
  - Weco A11y webinars
- Development 
  - [A11ycasts with Rob Dodson (YouTube)](https://www.youtube.com/playlist?list=PLNYkxOF6rcICWx0C9LVWWVqvHlYJyqw7g). 29 videos from Rob Dodson, Google dev and a11y advocate.
- Testing
  - [10 Quick Accessibility Tests (YouTube)](https://www.youtube.com/playlist?list=PLTqm2yVMMUKWTr9XWdW5hJ9tk512Ow0SE) from Tetralogical
...
- Development / testing
  ...
  - [The Blog by Sara Soueidan](https://www.sarasoueidan.com/about/) + course?
  - [Maia Miller's accessibility tips on LinkedIn](https://www.linkedin.com/in/maiamiller/)
...
- All roles
  - [Global Accessibility Awareness Day](https://accessibility.day/) — online
